<html>
<head>
<title>Xbox Games <--> DoNotCompare</title>
...
$game_array=consecutive($table,array('Xbox'));
$game1=$game_array[0];
$game2=$game_array[1];
...
echo "<H1>Game Ranking (Xbox)</H1>
<p align=center>
<font size='5'> Choose one</font><br/>
<font size='2'>(or select another sub-category: 
<a href='ps.php'><font size='2'color='#0000ff'><u>PlayStation</u></font></a> 
...
<table border=0 cellspacing=0 cellpadding=0 align=center
 ...
 <tr>
		...
		<td align=center>
				<a href='xbox.php?id1=$game1->id&id2=$game2->id&wina=1'>
		...
		<td align=center>
				<a href='xbox.php?id1=$game1->id&id2=$game2->id&wina=0'>
 ...
 <tr>
		<td align=left>  
				<a href='xbox.php?report=$game1->id'>  
					<WR>Wrong Image</WR>
				</a>  			
		</td>
		...
		<td align=right>
				<a href='xbox.php?report=$game2->id'>  
					<WR>Wrong Image</WR>
				</a>  			
		<td>
